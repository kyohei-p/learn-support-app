...
quiet_cmd__var_www_html_LaravelReactProject_node_v14_18_3_node_gyp_node_target_run_mkcodecache = ACTION _var_www_html_LaravelReactProject_node_v14_18_3_node_gyp_node_target_run_mkcodecache $@
cmd__var_www_html_LaravelReactProject_node_v14_18_3_node_gyp_node_target_run_mkcodecache = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/.; mkdir -p $(obj)/gen; "$(builddir)/mkcodecache" "$(obj)/gen/node_code_cache.cc"
...
$(obj)/gen/node_code_cache.cc: $(builddir)/mkcodecache FORCE_DO_CMD
	$(call do_cmd,_var_www_html_LaravelReactProject_node_v14_18_3_node_gyp_node_target_run_mkcodecache)

all_deps += $(obj)/gen/node_code_cache.cc
action__var_www_html_LaravelReactProject_node_v14_18_3_node_gyp_node_target_run_mkcodecache_outputs := $(obj)/gen/node_code_cache.cc

### Rules for action "node_mksnapshot":
quiet_cmd__var_www_html_LaravelReactProject_node_v14_18_3_node_gyp_node_target_node_mksnapshot = ACTION _var_www_html_LaravelReactProject_node_v14_18_3_node_gyp_node_target_node_mksnapshot $@
cmd__var_www_html_LaravelReactProject_node_v14_18_3_node_gyp_node_target_node_mksnapshot = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/.; mkdir -p $(obj)/gen; "$(builddir)/node_mksnapshot" "$(obj)/gen/node_snapshot.cc"
...
$(obj)/gen/node_snapshot.cc: $(builddir)/node_mksnapshot FORCE_DO_CMD
	$(call do_cmd,_var_www_html_LaravelReactProject_node_v14_18_3_node_gyp_node_target_node_mksnapshot)

all_deps += $(obj)/gen/node_snapshot.cc
action__var_www_html_LaravelReactProject_node_v14_18_3_node_gyp_node_target_node_mksnapshot_outputs := $(obj)/gen/node_snapshot.cc
...
$(builddir)/node: | $(action__var_www_html_LaravelReactProject_node_v14_18_3_node_gyp_node_target_run_mkcodecache_outputs) $(action__var_www_html_LaravelReactProject_node_v14_18_3_node_gyp_node_target_node_mksnapshot_outputs)

# Preserve order dependency of special output on deps.
$(action__var_www_html_LaravelReactProject_node_v14_18_3_node_gyp_node_target_run_mkcodecache_outputs) $(action__var_www_html_LaravelReactProject_node_v14_18_3_node_gyp_node_target_node_mksnapshot_outputs): | $(obj).target/deps/histogram/libhistogram.a $(obj).target/deps/uvwasi/libuvwasi.a $(obj).target/libnode.a $(builddir)/mkcodecache $(builddir)/node_mksnapshot $(obj).target/tools/v8_gypfiles/libv8_snapshot.a $(obj).target/tools/v8_gypfiles/libv8_libplatform.a $(obj).target/tools/icu/libicui18n.a $(obj).target/tools/icu/icuuc.stamp $(obj).target/deps/zlib/libzlib.a $(obj).target/deps/llhttp/libllhttp.a $(obj).target/deps/cares/libcares.a $(obj).target/deps/uv/libuv.a $(obj).target/deps/nghttp2/libnghttp2.a $(obj).target/deps/brotli/libbrotli.a $(obj).target/deps/openssl/libopenssl.a $(builddir)/openssl-cli $(obj).target/deps/googletest/gtest_prod.stamp $(obj).target/tools/v8_gypfiles/generate_bytecode_builtins_list.stamp $(obj).target/tools/v8_gypfiles/run_torque.stamp $(obj).target/tools/v8_gypfiles/v8_maybe_icu.stamp $(obj).target/tools/icu/libicuucx.a $(obj).target/tools/icu/icu_implementation.stamp $(obj).target/tools/icu/icu_uconfig.stamp $(obj).target/tools/icu/icu_uconfig_target.stamp $(obj).target/tools/icu/libicudata.a $(obj).host/tools/icu/icu_implementation.stamp $(obj).target/tools/v8_gypfiles/libv8_base_without_compiler.a $(obj).target/tools/v8_gypfiles/torque_generated_definitions.stamp $(obj).target/tools/v8_gypfiles/v8_headers.stamp $(obj).target/tools/v8_gypfiles/v8_version.stamp $(obj).target/tools/v8_gypfiles/libv8_libbase.a $(obj).target/tools/v8_gypfiles/libv8_libsampler.a $(obj).target/tools/v8_gypfiles/v8_shared_internal_headers.stamp $(obj).target/tools/v8_gypfiles/libv8_zlib.a $(obj).target/tools/v8_gypfiles/run_gen-regexp-special-case.stamp $(obj).target/tools/v8_gypfiles/postmortem-metadata.stamp $(obj).target/tools/v8_gypfiles/v8_compiler_for_mksnapshot.stamp $(obj).target/tools/v8_gypfiles/libv8_compiler.a $(obj).target/tools/v8_gypfiles/libv8_initializers.a $(obj).target/tools/v8_gypfiles/torque_generated_initializers.stamp
